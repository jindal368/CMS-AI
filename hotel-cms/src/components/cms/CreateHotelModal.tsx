...
export default function CreateHotelModal({ isOpen, onClose }: CreateHotelModalProps) {
  ...
  return (
    ...
    >
      ...
      {/* Modal card */}
      <div className="relative z-10 w-full max-w-lg mx-4 bg-[#ffffff] border border-[#e2dfe8] rounded-2xl shadow-2xl shadow-black/40">
        {/* Header */}
        <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-[#e2dfe8]">
          <h2 className="text-base font-semibold text-[#1a1a2e]">Create Hotel</h2>
          <button
            type="button"
            onClick={handleClose}
            disabled={isLoading}
