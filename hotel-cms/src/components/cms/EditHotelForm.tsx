...
const categoryColors: Record<string, string> = {
  ...
  budget: "text-[#7c7893] bg-[#7c7893]/10 border-[#7c7893]/20",
};

const inputClass =
  "w-full px-3 py-2 rounded-lg bg-[#f0eef5] border border-[#e2dfe8] focus:border-[#7c5cbf] focus:outline-none text-[#1a1a2e] text-sm placeholder:text-[#7c7893] transition-colors";

const labelClass = "block text-xs font-medium text-[#7c7893] mb-1";
    ...
    return (
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div className="flex items-start gap-4">
          <div className="w-12 h-12 rounded-xl bg-[#f0eef5] flex items-center justify-center text-xl font-bold text-[#e85d45] shrink-0">
          ...
          <div>
            ...
            <div className="mt-2 flex flex-wrap gap-x-5 gap-y-1 text-xs text-[#7c7893]">
              {contact?.email && (
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#f0eef5] hover:bg-[#e2dfe8] border border-[#e2dfe8] text-[#1a1a2e] text-xs font-medium transition-colors"
        >
          <svg viewBox="0 0 20 20" fill="currentColor" className="w-3.5 h-3.5">
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-semibold text-[#1a1a2e]">Edit Hotel</h3>
        ...
        <div>
          ...
          >
            {["luxury", "boutique", "business", "resort", "budget"].map((c) => (
              <option key={c} value={c} className="bg-[#f0eef5] capitalize">
      ...
      {/* Contact info */}
      <div>
        <p className="text-xs font-semibold text-[#7c7893] uppercase tracking-wider mb-3">Contact</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
      ...
      {/* SEO */}
      <div>
        <p className="text-xs font-semibold text-[#7c7893] uppercase tracking-wider mb-3">SEO</p>
